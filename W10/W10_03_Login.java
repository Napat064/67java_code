...
public class W10_03_Login {
    ...
    //สร้างตัวแปล username และ password
    String username = "admin";
    String password = "1234";
    Scanner kb = new Scanner(System.in);
    //สร้างตัวแปล username และ password ที่ผู้ใช้ป้อนเข้ามา
